...
import com.proptelligencenet.proptelligence.viewmodels.AhmedabadViewModel

@Composable
fun AhmedabadProp(navController: NavController) {
    val viewModel: AhmedabadViewModel = viewModel()
    val ahmedabadProperties by viewModel.ahmedabadProperties.collectAsState()
    ...
    CustomDrawer(
        ...
        Scaffold(
            ...
            Column(
                ...
                if (ahmedabadProperties == null && !timeoutOccurred) {
                    //Text(text = "Loading properties...", color = Color.Black)
                    CircularProgressAnimated()

                } else {
                    LazyColumn {
                        items(ahmedabadProperties ?: listOf()) { property ->
...
@Composable
fun AhmedabadPropPreview() {
    AhmedabadProp(rememberNavController())
}
