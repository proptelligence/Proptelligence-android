...
class AhmedabadViewModel : ViewModel() {
    private val _ahmedabadProperties = MutableStateFlow<CitiesInfo?>(null)
    val ahmedabadProperties = _ahmedabadProperties.asStateFlow()
