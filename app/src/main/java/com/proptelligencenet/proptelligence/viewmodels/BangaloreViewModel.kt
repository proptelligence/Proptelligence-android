...
class BangaloreViewModel: ViewModel() {
    private val _bangaloreProperties = MutableStateFlow<CitiesInfo?>(null)
    val bangaloreProperties = _bangaloreProperties.asStateFlow()
        ...
        viewModelScope.launch {
            ...
            try {
                withTimeout(20000) { // Timeout duration in milliseconds
                    _bangaloreProperties.value = NetworkModule.getPropertyService().getBangaloreProperties()
                }
                _errorMessage.value = ""
